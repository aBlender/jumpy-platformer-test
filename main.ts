...
sprites.onOverlap(SpriteKindLegacy.Player, SpriteKindLegacy.Flier, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
...
sprites.onOverlap(SpriteKindLegacy.Player, SpriteKindLegacy.Bumper, function (sprite, otherSprite) {
